...
Just a week out from the opening match, I'm recording the current predictions being made by my club level model. These predictions are updated a few times a week [here](\comp_files\\Rugby_World_Cup_2023) as matches are played and new information becomes available, but they shouldn't change much before kickoff, and recording them here allows for evaluation once matches are played. (Note - the page refereced above doesn't exist anymore. Shows I was right.)
