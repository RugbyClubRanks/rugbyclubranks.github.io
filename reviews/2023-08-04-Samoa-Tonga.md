...
![Projected Performances](plots/performances_2023-08-04-Samoa-Tonga.png)
## Projected Spreads


![Projected Spreads](plots/spreads_2023-08-04-Samoa-Tonga.png)
## Projected Results


![Projected Results](plots/resultbar_2023-08-04-Samoa-Tonga.png)
...
![In Match Scores](plots/recap_scores_2023-08-04-Samoa-Tonga.png)
## Win Probability over Time


![In Match Predictions](plots/recap_prob_2023-08-04-Samoa-Tonga.png)
...
Treating teams instead as an entity made up of the currently active players, I have ratings for each player in an altogether different system. These can be combined to form team ratings once teamsheets are announced, weighting starters a bit higher than the reserves. After the match is played, players can be weighted by their minutes on the field, allowing for an accurate measure of the team's composition. With these compiled team ratings, we can make predictions, measure inaccuracy, and update the individual player ratings.
## Prediction with Player Minutes: Tonga by 0.3


Tonga by 3.5 on a neutral field
## Prediction without Player Minutes: Tonga by 1.1


Tonga by 4.2 on a neutral pitch
...
|             80 | George Moala        |      77.15 |           50    |       13 |           46.06 |      50.58 | Ulupano Seuteni       |             31 |
