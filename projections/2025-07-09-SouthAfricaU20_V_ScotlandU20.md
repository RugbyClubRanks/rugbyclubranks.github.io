...
The first set of predictions treats a club as the smallest object, as the club develops its members, organizes a gameplan, and deploys its players as needed for each match. This club model is currently predicting South Africa U20 to win by 4.6.

Our Over/Under is 12.5 - and combined with the spread above, we have a predicted scoreline of 9 to 4
