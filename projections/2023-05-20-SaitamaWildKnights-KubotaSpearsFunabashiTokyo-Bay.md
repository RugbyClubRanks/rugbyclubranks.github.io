...
The first set of predictions treats a club as the smallest object, as the club develops its members, organizes a gameplan, and deploys its players as needed for each match. This club model has a prediction of 0.683, which translates to predicting Saitama Wild Knights to win by 6.9.
...
## Prediction with Imputed Lineups: Kubota Spears Funabashi Tokyo-Bay by 4.7


Kubota Spears Funabashi Tokyo-Bay by 8.7 on a neutral pitch
